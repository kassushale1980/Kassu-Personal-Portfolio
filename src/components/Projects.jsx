...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      {
      title: "ADT Transportation Service",
      image: "/images/Suburban-SUV3.JPG",
      description: "Transportation service platform built with React and Bootstrap.",
      code: "https://github.com/kassushale1980/adt-transportation.git",
      demo: "https://abeil-adt-transportation.netlify.app/",
    },
  ];
